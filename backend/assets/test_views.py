...
class TestAssetListView:
    ...
    def test_viewer_sees_only_active_assets(self, api_client, viewer_user, asset, inactive_asset):
        """Test that viewer sees only active assets"""
...
class TestAssetCreateView:
    ...
    def test_editor_can_create_asset(self, api_client, editor_user):
        ...
        assert response.data['title'] == 'New Asset'
        assert response.data['user']['username'] == 'editor'
